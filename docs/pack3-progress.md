...
- [~] T-12 Phiếu xuất hàng đem đổi (mig 049 — swap_stock_movements table linked to stock_entries, tracks qty + qty_returned + fifo_consumptions snapshot for re-stocking. inventory/stock-out picking page: dashed amber section "Hàng đem đi đổi (dự phòng)" with + Thêm SP dialog backed by lazy-loaded product catalog, qty/reason editable rows. Save flow appends [Swap]-tagged stock_entry_lines + swap_stock_movements rows. inventory/entries/[id] print slip splits "HÀNG THEO ĐƠN" vs dashed-bordered "HÀNG ĐEM ĐI ĐỔI" sections. T-07 unused-swap-stock wiring deferred — Q7.)
