...
import { ORDER_STATUS_MAP, CUSTOMER_STATUS_MAP, DELIVERY_STATUS_MAP, RETURN_STATUS_MAP, PO_STATUS_MAP, PURCHASE_INVOICE_STATUS_MAP } from "@/lib/constants"

type StatusType = "order" | "customer" | "delivery" | "return" | "po" | "purchase_invoice"
